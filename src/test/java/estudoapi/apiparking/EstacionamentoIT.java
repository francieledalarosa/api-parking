...
@Sql(scripts = "/sql/estacionamentos/estacionamentos-inserts.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
...
public class EstacionamentoIT {
    ...
    @Test
    public void criarCheckin_ComPerfilAdmin_RetornarDadosStatus200() {
