...
import estudoapi.apiparking.jwt.JwtUserDetails;
import estudoapi.apiparking.repository.projection.ClienteVagaProjection;
import estudoapi.apiparking.service.ClienteVagaService;
...
import estudoapi.apiparking.web.dto.PageableDto;
import estudoapi.apiparking.web.dto.mapper.ClienteVagaMapper;
import estudoapi.apiparking.web.dto.mapper.PageableMapper;
    ...
    @Operation(summary = "Operação de check-in", description = "Recurso para dar entrada de um veículo no estacionamento. " +
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Causas possiveis: <br/>" +
                            ...
                            content = @Content(mediaType = " application/json;charset=UTF-8",
                                    schema = @Schema(implementation = ErrorMensage.class))),
