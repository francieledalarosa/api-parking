...
import estudoapi.apiparking.service.ClienteService;
...
import estudoapi.apiparking.web.dto.mapper.ClienteMapper;
...
@Tag(name = "Clientes", description = "Recurso relacionado as operações com o cliente!")
...
public class ClienteController {
    ...
    @Operation(summary = "Criar um novo cliente",
            description =  "Recurso para criar um novo cliente, vinculado à um usuário cadastrado." + "" +
            "Requisição exige uso de um Bearer token. Acesso restrito a role 'CLIENTE'",
            security = @SecurityRequirement(name = "security"),
            responses = {
                    @ApiResponse(responseCode = "201", description = "Cliente criado com sucesso!",
                            content = @Content(mediaType = "application/json;charset=UTF-8", schema = @Schema(implementation = ClienteResponseDto.class))),
                    @ApiResponse(responseCode = "403", description = "Não permitido ao perfil 'ADMIN'!",
                            content = @Content(mediaType = "application/json;charset=UTF-8",  schema = @Schema(implementation = ErrorMensage.class))),
